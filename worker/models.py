"""
SQLAlchemy models for the worker service.
Replicated from the API models to maintain consistency.
"""
...
class Job(Base):
    ...
    country = Column(String(8), nullable=False)  # Supports ISO code and "GENERIC"
